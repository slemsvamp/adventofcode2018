            ...
            for (int y = 0; y < lines.Length; y++) {
                ...
                for (var x = 0; x < lineLength; x++) {
                    ...
                    if (@"/\|-+<^>v".Contains(current)) {
                        ...
                        switch (lines[y][x]) {
                            case '<':
                                cart = new Cart { Location = rail, Facing = Direction.West };
                                break;
                            case '^':
                                cart = new Cart { Location = rail, Facing = Direction.North };
                                break;
                            case '>':
                                cart = new Cart { Location = rail, Facing = Direction.East };
                                break;
                            case 'v':
                                cart = new Cart { Location = rail, Facing = Direction.South };
                                break;
                            default: break;
                        }
                ...
                foreach (var cartToReAdd in cartsToReAdd) {
                    ...
                    try {
                        ...
                        if (ex.Message.StartsWith("An item with the same key has already been added.")) {
                            Console.WriteLine($"X={cartToReAdd.Location.X},Y={cartToReAdd.Location.Y}");
                            return;
                        }
                    }
                }
