...
namespace day12_subterranean_sustainability {
    class Part02 {
        ...
        class Cavern {
            ...
            public Dictionary<long, Generation> Generations { get; set; }
            ...
            internal void RemoveGeneration(long pGeneration) {
                Generations.Remove(pGeneration);
            }
        }
        ...
        public static void Run() {
            ...
            var lastGeneration = cavern.Generations[50000000000];
